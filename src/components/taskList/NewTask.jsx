...
const NewTask = ({elem}) => {
  return (
    <div className="bg-blue-500 rounded p-3 flex flex-col shrink-0 w-full sm:w-[48%] lg:w-[30%] h-auto">
    ...
    <div className="flex justify-between text-white pt-2">
          <motion.button whileTap={{scale:0.9}} className="bg-green-600 p-1 w-1/3 rounded">Accept</motion.button>
          <motion.button  whileTap={{scale:0.9}} className="bg-red-600 p-1 w-1/3 rounded">Reject</motion.button>
        </div>
  </div>
